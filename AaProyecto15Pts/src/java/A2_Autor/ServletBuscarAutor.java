 ...
 * @author brian
 */
@WebServlet(name = "ServletBuscarAutor", urlPatterns = {"/ServletBuscarAutor"})
public class ServletBuscarAutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(control.toUpperCase().equals("BUSCAR")){
            ...
            autor.BuscarRegistros(res, idBorrar);
