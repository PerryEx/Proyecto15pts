 ...
 * @author brian
 */
@WebServlet(name = "ServletBuscarLibro", urlPatterns = {"/ServletBuscarLibro"})
public class ServletBuscarLibro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      StringBuffer res = new StringBuffer();
        ...
        if(control.toUpperCase().equals("BUSCAR")){
            ...
            libro.BuscarRegistros(res, idBorrar);
